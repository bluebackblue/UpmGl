...
namespace BlueBack.Gl.Editor
{
	...
	*/
	public static class UpdatePackage
	{
		...
		*/
		#if(!DEF_USER_BLUEBACK_GL)
		[UnityEditor.MenuItem("BlueBack/Gl/UpdatePackage/Develop")]
		#endif
		public static void MenuItem_UpdatePackage_Develop()
		{
			UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmGl.git?path=BlueBackGl/Assets/UPM");
		}

		/** MenuItem_UpdatePackage_Last
		*/
		#if(!DEF_USER_BLUEBACK_GL)
		[UnityEditor.MenuItem("BlueBack/Gl/UpdatePackage/Last " + Version.packageversion)]
		#endif
		public static void MenuItem_UpdatePackage_Last()
		{
			string t_version = GetLastReleaseNameFromGitHub();
			if(t_version != null){
				UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmGl.git?path=BlueBackGl/Assets/UPM#" + t_version);
			}
		}
		...
		*/
		...
		{
			string t_url = "https://api.github.com/repos/bluebackblue/UpmGl/releases/latest";
